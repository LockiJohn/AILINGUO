    ...
    return (
        <div className="screen-container animate-fade-in">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--space-4)', marginBottom: 'var(--space-8)' }}>
                <button className="btn btn-primary btn-lg" style={{ flexDirection: 'column', gap: 8, padding: 'var(--space-5)' }} onClick={() => router.push('/course')}>
                    <span style={{ fontSize: '1.5rem' }}>📖</span>
                    Vai al Corso
                </button>
                <button className="btn btn-ghost btn-lg" style={{ flexDirection: 'column', gap: 8, padding: 'var(--space-5)' }} onClick={() => router.push('/review')}>
                    <span style={{ fontSize: '1.5rem' }}>🔁</span>
                    Ripassa Ora
                </button>
            </div>
