...
export default function LessonScreen() {
    ...
    if (!lesson) {
        return (
            <div className="screen-container">
                ...
                <button className="btn btn-ghost" onClick={() => navigate('/course')}>← Torna al corso</button>
            </div>
        )
    }
    ...
    return (
        <div className="screen-container animate-fade-in">
            <button className="btn btn-ghost btn-sm" style={{ marginBottom: 'var(--space-6)' }} onClick={() => navigate('/course')}>
                ← Torna al corso
            </button>
